...
/**
 * Entity\CareCategoryDiagnosi
 *
 * InnoDB free: 3072 kB
 *
 * @ORM\Entity(repositoryClass="CareCategoryDiagnosiRepository")
 * @ORM\Table(name="care_category_diagnosis")
 */
class CareCategoryDiagnosi
{
    /**
     * @ORM\Id
     ...
     *
     * @param integer $nr
     * @return \Entity\CareCategoryDiagnosi
     */
