...
/**
 * Entity\CareClassEncounter
 *
 * InnoDB free: 3072 kB
 *
 * @ORM\Entity(repositoryClass="CareClassEncounterRepository")
 * @ORM\Table(name="care_class_encounter")
 */
class CareClassEncounter
{
    /**
     * @ORM\Id
     ...
     * @return \Entity\CareClassEncounter
     */
    ...
    {
        return array('class_nr', 'class_id', 'name', 'LD_var', 'description', 'hide_from', 'status', 'history', 'modify_id', 'modify_time', 'create_id', 'create_time');
    }
}