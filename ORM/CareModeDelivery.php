...
/**
 * Entity\CareModeDelivery
 *
 * InnoDB free: 9216 kB
 *
 * @ORM\Entity(repositoryClass="CareModeDeliveryRepository")
 * @ORM\Table(name="care_mode_delivery")
 */
class CareModeDelivery
{
    /**
     * @ORM\Id
     ...
     *
     * @param integer $nr
     * @return \Entity\CareModeDelivery
     */
    ...
    {
        return array('nr', 'group_nr', 'mode', 'name', 'LD_var', 'description', 'status', 'modify_id', 'modify_time', 'create_id', 'create_time');
    }
}