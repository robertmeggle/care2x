...
/**
 * Entity\CarePharmaOrdercatalogReturn
 *
 * @ORM\Entity(repositoryClass="CarePharmaOrdercatalogReturnRepository")
 * @ORM\Table(name="care_pharma_ordercatalog_return", indexes={@ORM\Index(name="item_no", columns={"item_no"})})
 */
class CarePharmaOrdercatalogReturn
{
    /**
     ...
     * @return \Entity\CarePharmaOrdercatalogReturn
     */
