...
/**
 * Entity\CarePharmaProductsMainMovement
 *
 * InnoDB free: 9216 kB
 *
 * @ORM\Entity(repositoryClass="CarePharmaProductsMainMovementRepository")
 * @ORM\Table(name="care_pharma_products_main_movements", indexes={@ORM\Index(name="dept_id_2", columns={"dept_id"})}, uniqueConstraints={@ORM\UniqueConstraint(name="dept_id", columns={"dept_id", "data", "bill_nr", "atc", "qty", "price", "value", "expiry_date", "id_sub"})})
 */
class CarePharmaProductsMainMovement
{
    /**
     * @ORM\Id
     ...
     *
     * @param integer $id
     * @return \Entity\CarePharmaProductsMainMovement
     */
