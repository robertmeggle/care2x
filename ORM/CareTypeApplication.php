...
/**
 * Entity\CareTypeApplication
 *
 * InnoDB free: 8192 kB
 *
 * @ORM\Entity(repositoryClass="CareTypeApplicationRepository")
 * @ORM\Table(name="care_type_application")
 */
class CareTypeApplication
{
    /**
     * @ORM\Id
     ...
     *
     * @param integer $nr
     * @return \Entity\CareTypeApplication
     */
