...
/**
 * Entity\CarePharmaOrderlistReturn
 *
 * @ORM\Entity(repositoryClass="CarePharmaOrderlistReturnRepository")
 * @ORM\Table(name="care_pharma_orderlist_return", indexes={@ORM\Index(name="dept", columns={"dept_nr"}), @ORM\Index(name="order_nr", columns={"order_nr"}), @ORM\Index(name="dept_nr", columns={"dept_nr"})})
 */
class CarePharmaOrderlistReturn
{
    /**
     * @ORM\Id
     ...
     * @return \Entity\CarePharmaOrderlistReturn
     */
