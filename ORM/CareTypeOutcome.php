...
/**
 * Entity\CareTypeOutcome
 *
 * InnoDB free: 7168 kB
 *
 * @ORM\Entity(repositoryClass="CareTypeOutcomeRepository")
 * @ORM\Table(name="care_type_outcome")
 */
class CareTypeOutcome
{
    /**
     * @ORM\Id
