...
/**
 * Entity\CareTypeLocation
 *
 * InnoDB free: 7168 kB
 *
 * @ORM\Entity(repositoryClass="CareTypeLocationRepository")
 * @ORM\Table(name="care_type_location")
 */
class CareTypeLocation
{
    /**
     * @ORM\Id
     ...
     *
     * @param integer $nr
     * @return \Entity\CareTypeLocation
     */
